...
Additionally, please beware of the copyrights, credit people as much as needed and make serious modding job. This game series deserve it !
...
- DjeLib-2.1 and TduModLib-2.2.RC2 by Djey : http://forum.turboduck.net/threads/26531-Djey-TDU-Modding-Tools-II-Release-2100-Beta-22RC1

changelog for this build:
- [BUG-1] MiniBnkManager	 :  Euro\Bnk\fx\vfx_car.bnk Can not be repacked properly.
To be finalized :
- [FEAT-1] XMB : volume editor




TDUMT2:MINI BNK MANAGER QUICK GUIDE
-----------------------------------
...
(0) FEATURES
- Opens TDU/TDU2 BNK files and shows their contents
- Extracts ('unpacks') contents to a work directory (single extract, full extract)
- Re-integrates ('repacks') modified files in work directory to a new (TDU/TDU2) BNK file
- Dumps BNK file information for debugging/analysis purposes.
